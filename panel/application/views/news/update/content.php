<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <b><?= $product->title ?></b> Kaydını Düzenliyorsunuz
            ...
            <div class="widget-body">
                <form action="<?= base_url("product/update/$product->id") ?>" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Başlık" name="title" value="<?= $product->title ?>">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="m-0" data-plugin="summernote" data-options="{height: 250}"><?= $product->description ?></textarea>
                    </div>
